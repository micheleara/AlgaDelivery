...
public class Delivery {
    ...
    //método static facture para estanciar o delivey no status draft
    ...
    public void editPreparationDetails(PreparationsDetails details){
        verifyIfCanBeEdited();
    ...
    @AllArgsConstructor
    @Builder
    public static class PreparationsDetails{
